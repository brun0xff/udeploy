...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = var.parameter_store ? templatefile("${path.module}/task-definitions/parameter-store.tpl", local.task_def_params) : templatefile("${path.module}/task-definitions/cstore.tpl", local.task_def_params)
}
